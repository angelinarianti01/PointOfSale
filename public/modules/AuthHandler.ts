...
class AuthHandler {
	...
	loggingIn = (value)=>{ return true; };
	loggingOut = (value)=>{ return true; };
	...
	resetLogin() {
		if (this.authForm) {
			...
			document.querySelector<HTMLElement>(`#showLogin`).style.display = 'block';
			document.querySelector<HTMLElement>(`#showSignUp`).style.display = 'block';
